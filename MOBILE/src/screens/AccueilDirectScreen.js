...
// Info en direct : le fil animé par la rédaction web — flash, direct, et le
// service de vérification des rumeurs.
export default function AccueilDirectScreen() {
  ...
  const load = useCallback(async () => {
    const [a, p, f] = await Promise.all([
      articlesAPI.list({ pageSize: 20, portail: 'INFO_DIRECT' }),
