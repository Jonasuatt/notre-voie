    ...
    <div className="min-h-screen flex items-center justify-center bg-ink px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="card p-7">
          <h1 className="text-lg font-bold text-center">CMS 1 — Administration</h1>
          <p className="text-xs text-gray-500 text-center mt-1">Direction &amp; Régie publicitaire</p>
        ...
        <p className="text-center text-white/30 text-[11px] mt-6 font-mono">La Refondation S.A.</p>
      </div>
    </div>
  );
}
