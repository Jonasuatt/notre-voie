...
export default function DerniereMinute({ articles, basePath = '' }) {
  ...
  return (
    <div className="border-y border-[#5B6480] bg-[#2E3546]">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 flex items-stretch gap-0 overflow-x-auto">
        <span className="flex-none flex items-center gap-1.5 font-mono text-[10.5px] font-bold uppercase tracking-widest text-[#22D3EE] pr-4 py-2.5 border-r border-[#5B6480]">
        ...
        {articles.map((a) => (
          <Link
            ...
            className="flex-none flex items-center gap-2.5 px-4 py-2.5 border-r border-[#5B6480] last:border-r-0 hover:bg-white/5 transition-colors"
          >
