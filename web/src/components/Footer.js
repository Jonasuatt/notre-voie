      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 py-12 grid gap-10 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            <li><a href="/rubrique/politique" className="hover:text-white">Politique</a></li>
            <li><a href="/rubrique/economie" className="hover:text-white">Économie</a></li>
            <li><a href="/rubrique/vie-chere" className="hover:text-white">Vie chère</a></li>
            <li><a href="/rubrique/diaspora" className="hover:text-white">Diaspora</a></li>
            <li><a href="/verite-ou-intox" className="hover:text-white">Vérité ou Intox</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-mono text-[11px] tracking-widest uppercase text-gold mb-3">Notre Voie</h4>
          <ul className="space-y-2 text-sm text-white/70">
            <li><a href="/kiosque" className="hover:text-white">Kiosque numérique</a></li>
            <li><a href="/abonnement" className="hover:text-white">S&apos;abonner</a></li>
