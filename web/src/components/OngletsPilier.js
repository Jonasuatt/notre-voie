...
export default function OngletsPilier({ titre, onglets, basePath = '' }) {
  ...
  function defiler(direction) {
    rangeeRef.current?.scrollBy({ left: direction * 120, behavior: 'smooth' });
  }

  return (
    <div>
      <div className="flex items-center justify-between flex-wrap gap-4 pb-3 mb-6 border-b" style={{ borderColor: '#5B6480' }}>
