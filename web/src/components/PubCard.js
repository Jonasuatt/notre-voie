  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <span className="inline-block mt-3 text-[12px] font-bold bg-[#F0F0EE] text-[#062134] px-3.5 py-1.5 rounded-full group-hover:bg-coral group-hover:text-white transition-colors">
